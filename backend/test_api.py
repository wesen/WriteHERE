...
parser.add_argument(
    "--port", type=int, default=5001, help="Port the server is running on"
)
...
def test_ping():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(
                f"❌ API server returned unexpected status code: {response.status_code}"
            )
            return False
...
def test_simple_story_generation():
    ...
    try:
        ...
        payload = {
            ...
            "model": "gpt-4o",
            "apiKeys": {"openai": "sk-test-key", "claude": "sk-ant-test-key"},
        }
        ...
        if response.status_code == 200:
            ...
            for i in range(3):
                ...
                if status_response.status_code == 200:
                    ...
                    print(
                        f"   Elapsed time: {status_data.get('elapsedTime', 0):.1f} seconds"
                    )
                else:
                    print(
