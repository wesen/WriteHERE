...
class RegularDummyNode(AbstractNode):
    ...
    def plan(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        # Assemble data
        # Agent's plan
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        self.raw_plan: List[Dict[Any, Any]] = result["result"]  # type: ignore[assignment]
        # Parse the plan generated by the agent
        self.plan2graph(raw_plan=self.raw_plan, ctx=ctx)
        return result

    def update(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        return result

    def execute(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        return result

    def prior_reflect(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        return result

    def planning_post_reflect(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        return result

    def execute_post_reflect(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        result = agent.forward(self, memory, ctx=ctx, *args, **kwargs)
        return result

    def final_aggregate(self, agent: Agent, memory: Memory, ctx: Optional[ExecutionContext] = None, *args: Any, **kwargs: Any):
        if (
